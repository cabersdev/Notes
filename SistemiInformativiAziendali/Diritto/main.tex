...
\chapter{Lo Stato, la Costituzione e le forme di governo}

\begin{comment}
  
\section{La Costituzione Italiana: nascità, caratteri, struttura e principi fondamentali}
...
\subsection{Principi fondamenti della Costituzione italiana}
...
\subsubsection{Art 1 - Il principio democratico e lavorista}
...
\subsubsection{Art 2 -  Diritti inviolabili dell'uomo}
...
\subsubsection{Art 3 - L'uguaglianza}
...
\subsubsection{Art 4 - Il principio lavorista}
...
\subsubsection{Art 5 - Unità nazionale e autonomie locali}
...
\subsubsection{Art 6 - La tutela delle minioranze linguistiche}
...
\subsubsection{Art 7 - I rapporti tra lo stato e la chiesa cattolica}
...
\subsubsection{Art 8 - I rapporti tra lo stato e le altre confessioni religiose}
...
\subsubsection{Art 9 - Tutela della cultura della ricerca e del paesaggio}
...
\subsubsection{Art 10 - L'Italia e la comunità internazionale}
...
\subsubsection{Art 11 - Il ripudio della guerra}
...
\subsubsection{Art 12 - La bandiera italiana}
...
\section{I principi della forma di governo}
\subsection{La forma di governo}
\dfn{Forma di governo}{Con l'espressione forma di governo si intende il modo in cui lo Stato è organizzato: gli organi che lo rappresentano, i loro poteri e i rapporti reciproci}
\\
Le forme di governo sono la monarchia e la repubblica
\\
La parola repubblica significa che il bene pubblico (cioè lo Stato) appartiene a tutti. Il principio ispiratore della repubblica è che il governo deriva dalla volontà del popolo
\\
La repubblica può essere parlamentare o presidenziale
\\
\\
\subsubsection{Repubblica parlamentare}
\\
\dfn{Repubblica parlamentare}{La repubblica parlamentare (come quella italiana) si basa sulla centralità del Parlamento (i cui componenti sono eletti dal popolo), ma contempla anche un particolare collegamento tra il Parlamento e il Governo, che assicura al primo la supremazia politica sul secondo}
\\
\\
\begin{itemize}
  \item{Il Parlamento è l'organo più ampio, rappresenta tutto il popolo in quanto eletto direttamente dai cittadini}
  \item{Il Governo è più limitato e rapresenta una espressione di maggioranza del Parlamento}
\end{itemize}
\\
I due organi sono collegati tramite un rapporto di fiducia
\\
\subsubsection{Repubblica presidenziale}
\\
\dfn{Repubblica presidenziale}{Nelle repubbliche presidenziali (come la Francia e gli Stati Uniti), il parlamento e il Presidente della repubblica (che è anche il capo del governo) si trovano sullo stesso piano. Entrambi questi organi sono inoltre eletti direttamente dal popolo e hanno quindi identica "legittimazione democratica". Poiché sia il parlamento sia il Capo dello Stato derivano da una elezione popolare, non esiste nessuna dipendenza politica di un organo rispetto a all'altro}
\\
La forma di governo prevista dalla Costituzione italiana è la repubblica parlamentare caraterizzata dai seguenti elementi:
\begin{itemize}
  \item Separazione dei poteri;
  \item Rappresentanza politica;
  \item Partiti politici.
\end{itemize}
\\
\subsection{La separazione dei poteri}
\\
\dfn{Separazione dei poteri}{La separazione dei poteri consiste nella suddivisione del potere dello Stato in tre poteri distinti (legislativo, esecutivo e giudiziario) e nell'atribuzione di ciascuno di essi a organi diversi e indipendenti tra loro (rispettivamente: Parlamento, Governo e Magistratura)}
\\
La reciproca indipendenza degli organi fa sì che nessuno possa dominare sugli altri. Da ciò nasce uno spontaneo equilibrio di pesi e contrappesi.
\\
Gli organi tra i quali è suddiviso il potere dello Stato sono elementi della forma di governo delineata dalla Costituzione: si dicono, perciò, organi costituzionali e si considerano reciprocamente sovrani, ciascuno con le proprie funzioni.
\\
\subsubsection{La separazione dei poteri nella Costituzione italiana}
In relazione alla separazione dei poteri, la nostra costituzione distingue:
\begin{itemize}
  \item Il potere legislativo, il quale spetta al Parlamento (art. 70 ss. Cost.);
  \item Il potere esecutivo, il quale spetta al Governo (art. 92 ss. Cost.);
  \item Il potere giudiziario, il quale spetta alla Magistratura (art. 101 ss. Cost.).
\end{itemize}
\\
Tra tali organi dello Stato è necessaria collaborazione, per evitare conflitti e disordine costituzionale.
\\
Per questo motivo accanto ai tre poteri tradizionali vi è anche un potere di "controllo" in grado di impedire le prevaricazioni reciproche ed evantualmente ricostituire l'equilibrio. 
\\
Tale potere spetta agli organi di garanzia costituzionale, ovvero:
\\
\begin{itemize}
  \item Il presidente della Repubblica, al quale spetta di rappresentare l'unità nazionale e garantire il buon funzionamento degli organi costituzionalim prevenendo l'insorgere di conflitti (art. 83 ss. Cost.);
  \item La corte costituzionale, alla quale spetta il compito di reprimere le violazioni della Costituzione (art. 143 Cost.).
\end{itemize}
\\
Tra il parlamento e il governo oltre al rapporto di fiduzia reciproco esiste una stretta collaborazione di indirizzo politico dello Stato.
\\
Mentre la magistratura è totalmente autonoma e indipendente da ogni altro potere dello Stato.
\\
\subsection{Democrazia e rappresentanza}
\\
Democrazia e rappresentanza esprimono concetti diversi.
\\
\begin{itemize}
  \item La democrazia, come potere del popolo, richiede che i governanti coincidano con i governati;
  \item La rappresentanza si basa, invece, su una distinzione tra governanti e governati.
\end{itemize}
\\
\subsubsection{Democrazia rappresentativa}
\\
E' possibile unire i concetti di democrazia e rappresentanza col termine democrazia rappresentativa
\\
\dfn{Democrazia rappresentativa}{La democrazia rappresentativa esiste quando si stabilisce una corrispondenza di intenti tra rappresentanti e rappresentati; quando, cioè, si può dire che la volontà dei primi è anche quella dei secondi}
\\
In italia un esempio di applicazione della democrazia rappresentativa riguarda la funzione legislativa.
\\
Ciò è garantito da due strumenti strettamenti connessi: le elezioni e i partiti politici
\\
\begin{itemize}
  \item Con le libere elezioni, il popolo può scegliere i propri rappresentanti
  \item Ai partiti spetta elaborare le proposte politiche da sottoporre agli elettori e indicare coloro che si candidano per realizzarle
\end{itemize}
\\
Gli elettori a loro volta, hanno il compito di scegliere tra le diverse proposte e di eleggere i candidati
\\
\subsubsection{La democrazia diretta}
\\
Il sistema democratico previsto dalla nostra Costituzione è fondamentalmente, ma non esclusivamente, rappresentativo
\\
Esiste infatti uno strumento di democrazia diretta, che è il referendum abrogativo (art. 75 Cost.)
\\
\dfn{Referendum abrogativo}{Con il referendum abrogativo il popolo può votare direttamente per decidere se mantenere o abrogare (cioè abolire) leggi in vigore}
\\
Inoltre la Costituzione attribuisce al popolo altri due poteri (quest'ultimi di scarsissima efficacia):
\\
\begin{itemize}
  \item La petizione, con la quale tutti i cittadini possono rivolgersi al Parlamento per chiedere provvedimenti legislativi ed esporre comuni necessità (art. 50 Cost.);
  \item L'iniziativa legilativa, con cui 50.000 cittadini possono sottoporre al Parlamento un progetto di legge perché sia esaminato (art. 71, c.2, Cost.).
\end{itemize}
\\
Questi due poteri sono solo apparentemente di democrazia diretta: in realtà essi servono a sollecitare l'attività parlamentare.
\\
\subsubsection{Il diritto al voto}
\\
E' essenziale che il sistema politico garantisca il corretto esercizio del diritto di voto, senza il quale non si potrebbe parlare di democrazia.
\\
il voto è:
\\
\begin{itemize}
  ...
  \item Personale;
  \item Uguale;
  \item Libero e Segreto.
\end{itemize}
\\
\dfn{Universalità del voto}{Universalità del voto significa che sono elettori tutti i cittadini, uomini e donne, che hanno raggiunto la maggiore età}
\\
L'articolo 48, u.c., Cost. tuttavia consente alla legge di privare del diritto di voto alcuni sogetti che si trovano in situazioni particolare, per esempio gli interdetti
\\
\dfn{Elettorato attivo e passivo}{con l'espressione elettorato attivo si indica il diritto di essere elettore. L'insieme dei cittadini aventi diritto di voto costituisce il corpo elettorale. Il diritto a essere eletti, si definisce elettorato passivo}
\\
\dfn{Personalità}{Personalità del voto significa che ciascun elettore deve far uso di persona del suo diritto e non può delegarlo agli altri}
\\
\dfn{Uguaglianza}{Uguaglianza significa che il voto di ciascuno vale quanto quello di tutti gli altri}
\\
Libertà e segretezza inoltre tutelano il diritto di voto
\\
La costituzione riconosce non solo che il voto è un diritto, ma stabilisce anche che il suo esercizio è un dovere civico (art. 48, c.2)
\\
Dire dovere civico significa però escludere che si tratti di un dovere giuridico
\\
L'assenza di obbligo giuridico consente l'astenzione dal voto. questo è un fenomeno assai diffuso in tutte le democrazie del mondo e rappresenta il cosidetto Indebolimento della democrazia
\\
\subsection{I partiti politici}
\\
I deputati e i senatori eletti in Parlamento sono esponenti dei partiti politci inoltre i componenti del parlamento seguono le direttive dei partiti di cui fanno parte
\\
Si può dire, perciò, che la democrazia rappresentativa è mediata dalla presenza dei partiti politici (mentre la democrazia diretta è immediata)
\\
La posizione mediana dei partiti può essere sia un collegamento sia un ostacolo tra il popolo e il parlamento
\\
\subsubsection{I partiti come associazioni di cittadini}
\\
\dfn{}{L'art 49 Cost. riconosce a tutti i cittadini il diritto di associarsi liberamente in partiti per concorrere con metodo democratico a determinare la politica nazionale}
\\ 
Inoltre, i partiti sono associazioni di cittadini garantite dall'art. 18 Cost "I cittadini hanno diritto di associarsi liberamente senza autorizzazione, per fini che non sono vietati ai singoli dalla legge penale"
\\
...
\\
\begin{itemize}
  \item Organizzare politicamente i cittadini, elaborando le proprie proposte politiche e, sulla base di queste, chiedere adesioni;
  \item Selezionare i candidati per le elezioni;
  \item Organizzare gli eletti, in modo che essi agiscano conformemente alle indicazioni dei partiti ai quali appartengono;
  \item Mantenere vivo il collegamento tra gli elette e gli elettori, nell'intervallo tra una elezione e quella successiva.
\end{itemize}
\\
\chapter{L'organizzazione costituzionale} % (fold)
\label{chap:L'organizzazione costituzionale}
\section{Il parlamento}
\\
\subsection{Il bicameralismo perfetto}
\\
...
\\
\\
Il parlamento è un'organo bicamerale, infatti è composto da due "Camere" o "rami": la Camera dei deputati e il Senato della Repubblica, i quali hanno sede, rispettivamente nel palazzo Montecitorio e palazzo Madama
\\
\\
La doppia camera si deve all'assemblea costituente, La camera dei deputati avrebbe dovuto rappresentare l'intero popolo nel suo insieme, mentre il Senato avrebbe dovuto rappresentare le Regioni, Tuttavia in Italia non esiste una sostanziale differenza tra le due camere
\\
\\
Le camere, per quanto operino separatamente, svolgono le medesime funzioni e i loro membri vengono eletti con criteri pressoché analoghi
\\
\\
Per indicare la parità dei poteri fra le due camere si utilizza l'espressione bicameralismo perfetto
\\
\\
Il bicameralismo perfetto consente di correggere nella seconda camera gli eventuali errori o leggerezze commessi dalla prima nella fase di approvazione di una legge.
\\
Le differenze tra le due camere riguardano, la composizione e i criteri di elezione:
\begin{itemize}
  \item I componenti della camera sono 400, mentre quelli del Senato sono 200;
  \item Per eleggere i deputati occorre aver compiuto 18 anni, per essere eletti alla camera dei deputati occorre invece aver compiuto 25 anni, per eleggere i senatori occorre aver compiuto 18 anni mentre per essere eletti come senatori occorre aver compiuto 40 anni, inoltre per diventare presidente della repubblica occorre aver compiuto 50 anni;
\end{itemize}
\\
Vi sono poi situazioni straordinarie in cui le due camere si riuniscono in seduta comune, la casistica che prevede questa riunione in seduta straordinaria sono:
\begin{itemize}
  \item L'elezione e il giuramento del Presidente della Repubblica;
  \item La messa in stato d'accusa del Presidente della Repubblica;
  \item L'elezione di 5 giudici costituzionali;
  \item L'elezione di 8 componenti del Consiglio Superiore della Magistratura.
\end{itemize}
\\
\subsection{Le norme elettorali per il parlamento}
\\
\subsubsection{Elettorato attivo ed elettorato passivo}
\\
L'art. 48 della Costituzione stabilisce che "sono elettori tutti i cittadini, uomini e donne, che hanno raggiunto la maggiore età".
\\
\\
Tale norma disciplina il cosidetto elettorato attivo, cioè la capacità di votare che è subordinata a due requisiti: possedere la cittadinanza e la maggiore età. 
\\
\\
Dall'elettorato attivo deve essere distinto l'elettorato passivo, che consiste nella capacità di essere eletti.
\\
\\
Il sistema elettorale per il Parlamento è disciplinato da leggi ordinarie in quanto la Costituzione non si pronuncia sul sul sistema elettorale di esso
\\
\subsubsection{I sistemi elettorali}
\\
Chiunque venga eletto alle Camere ottiene un seggio: i sistemi elettorali sono i criteri usati per trasformare i voti in seggi.
\\
\\
Esistono due tipologie di sistemi elettorali:
\\
\begin{itemize}
  \item Sistemi maggioritari;
  \item Sistemi proporzionali.
\end{itemize}
\\
\dfn{I sistemi maggioritari}{I sistemi maggioritari sono quelli che assegnano i seggi solo a coloro che hanno ottenuto più voti: criterio riassunto nella formula "il primo prende tutto"}
\\
\dfn{I sistemi proporzionali}{I sistemi proporzionali, invece, non mirano a premiare il vincitore delle elezioni ma a rispecchiare i partiti in Parlamento, proporzionalmente al loro consenso elettorale. Ogni partito quindi, otterà in seggi quanto ha ottenuto in voti}
\\
Ogni stato che debba scegliere quale sistema elettorale adottare deve tener conto di due esigenze contrapposte ma egualmente importanti per il buon funzionamento della democrazia:
\\
\begin{itemize}
  \item Garantire la formazione di maggioranze parlamentari stabili, che assicurino la cosidetta "governabilità";
  \item Garantire un'adeguata rappresentanza parlamentare a tutti i partiti che abbiano conseguito voti.
\end{itemize}
\\
Il sistema maggioritario risponde meglio alla prima esigenza, cioè alla governabilità, mentre quello proporzionale permette la rappresentanza di tutte le forze politiche in campo.
\\
\\
Può essere presente inoltre un sistema elettorale che ricorra a tutti e due i sistemi elettorali definito come sistema elettorale misto
\\
\subsubsection{Il sistema elettorale italiano}
\\
L'attuale legge elettorale (1.n. 165/2017) presenta aspetti sia maggioritari sia proporzionali. Entrambe le Camere sono dunque elette con un sistema misto.
\\
\\
\begin{itemize}
  \item $\frac{2}{3}$ dei deputati e dei senatori sono eletti con un sistema proporzionale, Ogni partito presenta in ciascun collegio una lista di candidati (non meno di 2 e non più di 4) e ottiene un numero di seggi proporzionale ai voti ricevuti. I collegi si dicono plurinominali poiché eleggono una pluralità di parlamentari;
  \item Il restante $\frac{1}{3}$ è eletto con un sistema maggioritario, in collegi uninominali (che eleggono, cioè, un solo parlamentare). Nei seggi assegnati con questo sistema, ogni partito o ogni coalizione di partiti presentano un solo candidato: vince quello che ha ottenuto più voti.
\end{itemize}
\\
E' inoltre previsto un correttivo al metodo proporzionale attraverso le clausole di sbarramento si escludono dall'attribuzione dei seggi i partiti che non hanno ottenuto una percentuale minima di voti, con tale clausola si risolve la problematica causata dall'eccessivo numero di parlamenti
\\
\\
Nella legge in vigore la sbarramento è prevista nella quota proporzionale ed è del 3\% su base nazionale per i partiti che si presentano da soli, e del 10\% per le coalizioni di partiti, all'interno della coalizzione, inoltre almeno una lista deve comunque aver ottenuto quantomeno il 3\% dei voti.
\\
\\
Per favorire la presenza femminile in Parlamento, sono state previste le quote rosa. che garanisce una quota di candidature riservate alle donne. ciascuno dei due sessi non può rappresentare più del 60\% dei capi listi presentati dai diversi partiti.
\\
\\
Gli Italiani residenti all'estero votano con un sistema proporzionale
\\
\subsection{La legislatura}
\\
\subsubsection{La duratura delle camere}
\\
La Camera dei deputati e il Senato della Repubblica sono eletti per 5 anni (art. 60, c.1, Cost) e il periodo di tempo compreso tra un elezione e l'altra è denominato legilatura.
\\
\\
La democrazia richiede che il popolo sia chiamato a rinnovare la rappresentanza a intervalli regolari. Per questo motivo, quindi, si stabilisce che la proroga delle Camere al di là del tempo normale della loro durata è ammessa solo con legge (cioè con atto del Parlamento stesso) e solo ed esclusivamente in caso di guerra
\\
\\
Alla continuità delle Camere di cui si è appena parlato corrisponde il principio contrario della discontinuità dei lavori parlamentari, tutti i procedimenti legislativi non conclusi al momento dello scioglimento devono ricominciare da capo davanti al nuovo Parlamento.
\\
\subsubsection{Lo scioglimento anticipato delle Camere}
\\
La normale durata delle Camere può essere abbreviata nel caso in cui il Presidente della Repubblica, secondo quanto previsto dall'art. 88 Cost. proceda allo scioglimento delle stesse.
\\
\\
Il potere di scioglimento anticipato è un potere di garanzia del Presidente della Repubblica, in quanto serve a rimettere in funzione un sistema politico-rappresentativo irimediabilmente "inceppato"
\\
\\
Il caso più frequente è quello in cui, per contrasti tra le forze politiche in Parlamento, sia impossibile formare una maggioranza che sostenga un Governo stabile
\\
\\
Il comma 2 dell'art. 88 Cost. stabilisce, però che il Presidente della Repubblica non possa scogliere anticipatamente le Camere negli ultimi 6 mesi del suo mandato settennale, periodo di tempo che viene definito semestre bianco
\\
\\
E' tuttavia, prevista un'eccezzione a questo divieto di carattere generale nel caso in cui il semestre bianco coincida in tutto o in parte con gli ultimi 6 mesi della legilatura
\\
\subsection{Rappresentanza politica e garanzie dei parlamentari}
\\
\subsubsection{La rappresentanza politica}
\\
Secondo l'art. 67 Cost. "Ogni membro del parlamento rappresenta la Nazione ed esercita le sue funzioni senza vincolo di mandato"
\\
\\
La Costituzione afferma un divieto di mandato imperativo, che libera i singoli parlamentari dal dovere di sottostare a specifici interessi, li responsabilizza e rende il parlamento un luogo di compromesso in cui si possa realmente operare in nome degli interessi generali e permanenti della Nazione.
\\
\\
Ciò non esclude un vincolo tra il parlamentare e il proprio partito, vincolo, che ha solo carattere politico e non giuridico
\\
\subsubsection{Le immunità parlamentari}
\\
Al fine di tutelare la libertà dei singoli parlamentari nell'esercizio delle loro funzioni, la Costituzione prevede una serie di prerogative che garantiscono l'indipendenza del Parlamento
\\
\\
Tali prerogative si dicono immunità parlamentari e sono l'insindacabilità per le opinioni espresse e i voti dati e l'inviolabilità o immunità penale
\\
\begin{itemize}
  \item Il parlamentare non può rispondere in alcuna sede: penale, civile e disciplinare. per le opinioni espresse e i voti dati nell'esercizio delle sue funzioni, si parla in questo caso di insindacabilità (art. 68, c.1 Cost)
\end{itemize}
\\
\ex{Insindacabilità parlamentare}{Se in un discorso in Parlamento, un parlamentare afferma la necessità di pene più severe che contrastino le attività illegali di Tizio, definito come "noto mafioso", questi non può chiederne la condanna penale per diffamazione né può pretendere il risarcimento del danno}
\\
\begin{itemize}
  \item{Se un parlamentare commette un reato comune, cioè al di fuori dell'esercizio delle sue funzioni, è perseguibile al pari di ogni altro cittadino 
\\
\\
Per poterne limitare la libertà occorre però una specie di autorizzazione a procedere dalla Camera cui appartiene che deve essere richiesta per:
\begin{itemize}
  \item L'arresto;
  \item La perquisizione personale o domiciliare;
  \item L'intercettazione delle comunicazione telefoniche, telematiche ed epistolari.
\end{itemize}
}
\end{itemize}
\\
Si parla in tal caso di inviolabilià o immunità penale
\\
\subsubsection{I casi di incompatibilità parlamentare}
\\
Talvolta la legge impedisce a uno stesso soggetto di ricoprire due cariche diverse: si parla, in questi casi, di incompatibilità 
\\
\\
La Costituzione si limita a prevedere qualche causa di incompatibilità, per esempio, fra la carica di deputato e quella di senatore, oppure fra la carica di Presidente della Repubblica e qualunque altra carica, inclusa quella di parlamentare (art. 84, c.2)
\\
\\
Per tutte le altre cause di incompatibilità che riguardano i parlamentari l'art. 65 Cosst. rinvia alla legge
\\
\\
Le cause di incompatibilità mirano a garantire l'efficienza, l'imparzialità o la distinzione fra funzioni
\\
\subsubsection{L'indennità parlamentare}
\\
I parlamentari ricevono un'indennità, oggi si tratta di una vera e propria retribuzione non rinunciabile. Essa è stabilita per legge, cioè dal Parlamento stesso
\\
\subsubsection{L'organizzazione interna delle Camere}
\\
Perché le Camere possano deliberare, è necessario che sia presente in aula la maggioranza
\\
\\
Esistono diversi tipi di maggioranze: la maggioranza semplice, la maggioranza assoluta e le maggioranze qualificate
\\
\\
Di regola le Camere deliberano a maggioranza semplice, cioè con il voto favorevole della metà più 1 dei presenti (numero variabile)
\\
\\
Eccezzionalmente si richiedono maggioranze più ampie:
\\
\begin{itemize}
  \item La maggioranza assoluta, cioè la metà più 1 dei componenti (numero non variabile);
  \item Le maggioranze qualificate, che sono maggioranze superiori a quella assoluta, richieste nei casi in cui si voglia coinvolgere le minoranze, per esempio i $\frac{2}{3}$ per deliberare l'amnistia
\end{itemize}
\\
Per quanto riguarda i metodi di votazione, si distingue il voto segreto dal voto palese
\\
\begin{itemize}
  \item Segreto è il voto elettronico, che si esprime attraverso pulsanti e che compare su un tabellone in forma anonima;
  \item Palese è il voto per appello nominale, quando il deputato o il senatore deve dichiarare il suo voto apertamente
\end{itemize}
\\
\subsubsection{I regolamenti delle Camere}
\\
Le Camere sono organi di grandi dimensioni che, per funzionare bene, richiedono una complessa organizzazione interna
\\
\\
L'organizzazione e lo svolgimento delle funzioni parlamentari trovano la loro disciplina fondamentale nel testo costituzionale e nei regolamenti parlamentari
\\
\\
L'art. 64, c.1 Cost. stabilisce, infatti, che: "ciascuna Camera adotta il proprio regolamento a maggioranza assoluta dei suoi componenti"
\\
\subsubsection{I Presidenti delle Camere}
\\
L'art. 63, c.1, Cost. stabilisce, infatti, che: "Ciascuna Camera elegge fra i suoi componenti in Presidente e l'ufficio di presidenza"
\\
\\
Il Presidente non è un organo di carattere politico, nell'ambito del suo ruolo istituzionale che richiede imparzialità, ha il compito di regolare l'attività di tutti gli organi del ramo del Parlamento che presiede facendone osservare il regolamento
\\
\\
La principale differenza tra il Presidente della Camera dei deputati e il Presidente del Senato dela Repubblica consiste nel fatto che il primo presiede il Parlamento in seduta comune, mentre il secondo supplisce il Capo dello Stato nelle ipotesi di impedimento
\\
\subsubsection{I gruppi parlamentari}
\\
Nell'organizzazione del Parlamento, un ruolo di primaria importanza è svolto dai Gruppi parlamentari, ossia dall'unione dei membri di una Camera che siano espressione dello stesso partito
\\
\\
Il numero minimo per dar vita a un Gruppo parlamentare è di 20 deputati alla Camera e di 10 senatori al Senato
\\
\\
Tutti i parlamentari devono essere iscritti a un Gruppo parlamentare, coloro che non si riconoscono in nessuno dei Gruppi esistenti, o che non hanno i numeri per dar vita a un nuovo Gruppo, confluiscono nel cosidetto Gruppo Misto, privo di una connotazione politica sua propria
\\
\\
I gruppi parlamentari sono, in via generale, espressione nel Parlamento dei partiti politici 
\\
\subsubsection{Le Commissioni parlamentari}
\\
Le commissioni parlamentari sono organi minori delle Camere. Sono composte da parlamentari di tutti i Gruppi, in proporzione al numero dei loro membri
\\
\\
Le commissioni possono essere permanenti o temporanee, bicamerali o monocamerali.
\\
\\
Le commissioni parlamentari permanenti sono organi stabili e necessari di ciascuna Camera, costituite all'inizio della legislatura e destinate a rimanere in carica fino alla fine della stessa; esse sono 14 in entrambi i  rami del Parlamento, competenti ciascuna su argomenti specifici
\\
\\
in particolare le Commissioni sono:
\\
\begin{itemize}
  \item Affari costituzionali, della Presidenza del Consiglio e degli Interni;
  \item Giustizia;
  \item Affari esteri e comunitari;
  \item Difesa;
  \item Bilancio, tesoro e programmazione;
  \item Finanze;
  \item Cultura, scienza e istruzione;
  \item Ambiente, territorio e lavori pubblici;
  \item Trasporti, poste e telecomunicazioni;
  \item Attività produttive, commercio e turismo;
  \item Lavoro pubblico e privato;
  \item Affari sociali;
  \item Agricoltura;
  \item Politiche dell'Unione Europea
\end{itemize}
\\
\\
Le Commisioni servono a decongestionare il lavoro parlamentare
\\
\\
Le commissioni parlamentari temporanee, invece, assolvono compiti specifici e durano in carica il tempo stabilito per l'adempimento della loro funzione.
\\
\\
Un esempio è quello delle commissioni parlamentari d'inchiesta esse sono istituite con il compito di indagare su fatti e situazioni di rilevanza politica in vista di eventuali provvedimenti 
\\
\\
Un ulteriore caso particolare è quello rappresentato dalle commissioni bicamerali: sono formate in parti eguali dai rappresentanti delle due Camere pur rispecchiando la proporzione dei vari Gruppi

% chapter L'organizzazione costituzionale (end)
\end{document}
